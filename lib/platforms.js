...
module.exports = {
    win32: {
        ...
        files: { // First file must be the executable
            ...
            '>=0.13.0-alpha3  <0.15.0': ['nw.exe', 'icudtl.dat', 'libEGL.dll', 'libGLESv2.dll', 'nw_100_percent.pak', 'nw_200_percent.pak', 'locales', 'd3dcompiler_47.dll', 'natives_blob.bin', 'node.dll', 'nw_elf.dll', 'nw.dll', 'resources.pak', 'snapshot_blob.bin', "ffmpeg.dll"],
            '>=0.15.0': ['nw.exe', 'icudtl.dat', 'libEGL.dll', 'libGLESv2.dll', 'nw_100_percent.pak', 'nw_200_percent.pak', 'locales', 'd3dcompiler_47.dll', 'natives_blob.bin', 'node.dll', 'nw_elf.dll', 'nw.dll', 'resources.pak', 'snapshot_blob.bin', "ffmpeg.dll", "nw_material_100_percent.pak", "nw_material_200_percent.pak"]
        },
